  ...
  >
    ...
    <div slot="footer">
      <!-- <Button type="primary" v-if="!adminFlag" @click="childClick('formInline')"
        >确认</Button
      > -->
      <Button @click="closee">关闭窗口</Button>
    </div>
  </Modal>
</template>
...
<script>
// 导入 树形图列表权限列表
import { getAuthsList, setAuth } from "@/api/platform-manager";
import { hasOneOf } from "@/libs/tools";

// import { getLists, getAuths, setAuth } from "@/api/platform-auth";
// import { cancelImpowerList, getImpowerList } from "@/api/user-list";
import { agentManage_cancel, agentManage_getList } from "@/api/user-list";
export default {
  // props: ["imporer"],
            ...
            h(
              "span",
              {
                ...
                style: {
                  ...
                  display: hasOneOf(
                    ["operate:agent-management:agent-delete-app"],
