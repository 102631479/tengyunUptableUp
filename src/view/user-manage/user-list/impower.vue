            ...
            h(
              "span",
              {
                ...
                style: {
                  ...
                  cursor: "pointer",
                  display: hasOneOf(
                    ["operate:user-manage:user-app-delete"],
  ...
  methods: {
    ...
    getListId(e) {
      ...
      getAuths({
        ...
        .then((d) => {
          console.log(d.data.expireDateTime, "expireDateTime");
          if (this.adminFlag)
            this.formInline.appExpireDateTime = d.data.expireDateTime;
